...
def getDisassembledCode(filename, delimeter='\n', bits='32bit'):
    """
        ...
        :rtype : str
    """
    iterable = diassemble(filename,bits)
...
def getAssemblyCode(filename, delimeter='\n', bits='32bit'):
...
def getAssemblyCodeList(filename, bits='32bit'):
